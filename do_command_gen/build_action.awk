...
{ 
    ...
    print "}"                                                                            >> "action.sh"
    print "function wait_for_video_device_release() {"                                   >> "action.sh"
    ...
    print "    done"                                                                     >> "action.sh"
    print "}"                                                                            >> "action.sh"
    print "function start_motion() {"                                                    >> "action.sh"
    print "    motion -c /home/ubuntu/.motion/motion.conf"                               >> "action.sh"
    print "}"                                                                            >> "action.sh"
    print "function terminate_motion() {"                                                >> "action.sh"
    ...
    if ($7 == "Motion")
    {
        ...
        print "               PIC_COUNTER=1"                                                >> "action.sh"
        print "               terminate_motion"                                             >> "action.sh"
